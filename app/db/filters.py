...
# #             raise BadFilterFormat('Operator `{}` not valid.'.format(operator)) # noqa: E501
...
#                 'Filter spec `{}` should be a dictionary.'.format(filter_spec) # noqa: E501
#             )
...
#                 return [
#                     BooleanFilter(
#                         boolean_function.sqlalchemy_fn, *build_filters(fn_args) # noqa: E501
#                     )
#                 ]
...
#         Example::
#             filter_spec = [
#                 {'model': 'Foo', 'field': 'name', 'op': '==', 'value': 'foo'}, # noqa: E501
#             ]
...
#             filter_spec = {
#                 'or': [
#                     {'model': 'Foo', 'field': 'id', 'op': '==', 'value': '1'}, # noqa: E501
#                     {'model': 'Bar', 'field': 'id', 'op': '==', 'value': '2'}, # noqa: E501
#                 ]
#             }
#     :returns:
